...
### Data file names
data = (#'vlbi_cal.005-2022.json', 
        #'vlbi_cal.013-2022.json',
        #'vlbi_cal.020-2022.json',
        #'vlbi_cal.024-2022.json',
        #'vlbi_cal.025-2022.json',
        #'vlbi_cal.026-2022.json',
        #'vlbi_cal.061-2022.json', # json.decoder.JSONDecodeError: Expecting property name enclosed in double quotes: line 348 column 5 (char 7628)
        'vlbi_cal.062-2022.json',
        'vlbi_cal.063-2022.json',
        'vlbi_cal.066-2022.json',
        'vlbi_cal.071-2022.json',
        'vlbi_cal.072-2022.json',
        'vlbi_cal.073-2022.json',
        'vlbi_cal.075-2022.json',
        'vlbi_cal.077-2022.json',
        'vlbi_cal.078-2022.json',
        'vlbi_cal.079-2022.json',
        'vlbi_cal.081-2022.json',
        'vlbi_cal.082-2022.json',
        'vlbi_cal.084-2022.json',
        'vlbi_cal.085-2022.json',
        'vlbi_cal.086-2022.json',
        'vlbi_cal.326-2022.json',
        'vlbi_cal.327-2022.json',
        'vlbi_cal.328-2022.json') 

### Iterate through the data files list
for file in range(len(data)):
    data_file = data[file]
    file_name = os.path.splitext(data_file)
    ...
    while pid_arr != {}:
        ...
        sys.stdout.flush()
    print("COMPLETE!")
    np.savez(file_name[0] + "_results_arr", results_arr)
    

    # Splitting the vlbi_cal from the obs number and the year
    file_num_date = file_name[0].rsplit(".", 1)
    file_num_date = file_num_date[1]
    ...
    plt.xlabel('k_d')
    plt.ylabel('k_i')
    plt.savefig(file_num_date + '_dvi.png', dpi=300)
    #plt.show()
    ...
    plt.xlabel('k_d')
    plt.ylabel('k_p')
    plt.savefig(file_num_date + '_dvp.png', dpi=300)
    #plt.show()
    ...
    plt.xlabel('k_i')
    plt.ylabel('k_p')
    plt.savefig(file_num_date + '_ivp.png', dpi=300)
    #plt.show()