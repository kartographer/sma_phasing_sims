...
### Data file names
data = 'vlbi_cal.023-2020.json'

# ('vlbi_cal.003-2020.json', 
...
for file in range(len(data)):
    data_file = data # usually is data[file] but only one usable file in this year

    # For keeping file naming consistent
    file_name, tail = os.path.splitext(data)
