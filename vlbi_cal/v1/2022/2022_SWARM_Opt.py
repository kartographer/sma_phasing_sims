...
### Data file names
# These are hard written in bc I did not know what files good/bad
# The bad files were commented out due to throwing on error (error pasted) or bad solutions calculated on first run of code
# data = (#'vlbi_cal.005-2022.json', # bad solutions
...
#         #'vlbi_cal.062-2022.json', # bad solutions
#         'vlbi_cal.063-2022.json',
#         #'vlbi_cal.066-2022.json', # bad solutions
#         #'vlbi_cal.071-2022.json', # bad solutions
...
#         #'vlbi_cal.326-2022.json', # bad solutions
